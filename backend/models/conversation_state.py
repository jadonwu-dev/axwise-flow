...
class ResearchQuestion(BaseModel):
    ...
    category: Literal["problem_discovery", "solution_validation", "follow_up"] = "problem_discovery"
...
class CustomerResearchState(BaseModel):
    ...
    def update_business_context(self, **kwargs) -> Dict[str, Any]:
        ...
        current_data = self.business_context.dict()
    ...
    def transition_to_stage(self, new_stage: ConversationStage, reason: str = None) -> Dict[str, Any]:
    ...
    def should_generate_questions(self) -> bool:
        ...
        return (
            self.conversation_stage == ConversationStage.GENERATING_QUESTIONS and
            self.user_confirmed and
            self.business_context.is_complete()
        )
    ...
    def get_api_response_format(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "questions": self.research_questions.to_legacy_format() if self.research_questions else None,
            "stakeholders": self.stakeholder_analysis.dict() if self.stakeholder_analysis else None,
            "session_id": self.session_id,
            "metadata": {
                "conversation_stage": self.conversation_stage.value,
                "business_context": self.business_context.dict(),
